...
func Banner(make_vars map[string]string) string {
    ...
    fmt.Fprintln(b, "dX.      'OXd.       .,coool;.  lNO.          .oK ")
    fmt.Fprintln(b, "ko      .kNo.      ;OXNWMMMWk'  'ON:           xN.")
    fmt.Fprintln(b, "Wl      cNO.      '0XxOWMMMMWl  '0Nc           XN ")
    fmt.Fprintln(b, "bl      oWx.      ,KXllKNNWXd. .oNO.           XW.")
    fmt.Fprintln(b, "No      oWx.       lX0l;;;;'.'cOXx'           .xN ")
    fmt.Fprintln(b, "lX'     ;XK,        ,d000OkkOK0d,             cX' ")    
    fmt.Fprintln(b, " Wo.    .xNd.         .';;::;'.              ;KW  ")
    fmt.Fprintln(b, "  Xc     'OXo.                              :Kl   ")
    fmt.Fprintln(b, "   Xl.    .kXx'                           .oXN    ")
